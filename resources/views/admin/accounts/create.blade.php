...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3 mb-0">Add Account</h1>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('payment_mode_id') is-invalid @enderror" id="payment_mode_id" name="payment_mode_id" required>
                                ...
                                @foreach($paymentMethods as $method)
                                    <option value="{{ $method->id }}" {{ old('payment_mode_id') == $method->id ? 'selected' : '' }}>{{ $method->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('upi_id') is-invalid @enderror" id="upi_id" name="upi_id" value="{{ old('upi_id') }}">
                                @error('upi_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
